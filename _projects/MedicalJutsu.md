...
By transferring your chakra to the recipient, you can stimulate the body to begin the recovery process and help stabilize their most basic functions (like breath rate and pulse). It lacks the precision of more advanced jutsu to target specific injuries and problems, but helps to keep people alive until they can receive advanced care.
 ...
 - Range: Touch
 - Speed: Special
 - Special: Abort, May be used on self
 - Requires: Flawless Diagnosis

Effects: When you use this techqnique, you pay its cost, and then begin a special VSA action: Vital Repair, during which you must keep both hands on its recipient.  If you are Stunned or Knocked away from them (or they from you), or if the recipient takes damage from any status effect while receiving this jutsu's effects, it is Aborted automatically, though like with other VSA's, you can choose to perform one other VSA alongside Vital Repair (Block, etc).

For every IC which passes, you heal 3 + (Chakra Control Ranks)/5 of the recipient's lost Hit Points.  This will not restore lost Vitality, though it will restore a person in negative Hit Points to consciousness.  If used on yourself, you still have to be able to place one hand on yourself to do so. 
...
Effects: This lasts for X * 5 IC. During that time, the damage the recipient takes from Bleed effects is reduced to 0, the Stamina penalties from Bleed effects is not applied, and they take damage from Poison once every 2 IC, rather than every IC.  The severity of Bleed statuses is reduced normally. During this time, they have a +5 bonus to all their Resistance rolls, and Medical VSA's will not be Aborted by Bleed or Poison damage taken.
...
Effects: When you use this techqnique, you pay its cost, and then begin a special VSA action: Mystic Palm, during which you must keep both hands on its recipient.  If you are Stunned or Knocked away from them (or they from you), or if the recipient takes damage from any status effect while receiving this jutsu's effects, it is Aborted automatically, though like with other VSA's, you can choose to perform one other VSA alongside Vital Repair (Block, etc).

For every IC which passes, you heal 6 + (Chakra Control Ranks)/5 of the recipient's lost Vitality.  This will not restore lost Hit Points.  If used on yourself, you still have to be able to place one hand on yourself to do so. 
