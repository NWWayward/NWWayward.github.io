...
The wound may not be prevented, healed, or ignored (such as from Strong Willed), except by ending the Genjutsu. If an effect would heal the wound, or an effect other than armor would prevent it, it does not work, but does make the victim aware that they are under a Genjutsu. Both you and the victim derive no benefit from a wound created with Brain Destruction: Kaguya do not gain a Skeletal Modification, Super Novice do not gain a Willpower, it does not interact with Killing Intent, etc.
