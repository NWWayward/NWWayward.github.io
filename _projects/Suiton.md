...
Effects: Any jutsu which is used inside the mist, or includes the mist as any part of its area, acts as if its user's ninjutsu damage bonus is 0 for any associated damage calculations. Additionally, this imposes a -8 visibility penalty to everyone in the area. You suffer only half the normal visibility penalty.
