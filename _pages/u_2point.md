...
Finally, you may perform a parry using one or more Small Thrown weapons by combining it with either a Basic Attack or a Multithrow as an Interrupt. When you do, add Parry's Speed to the attack as a link. The final Speed of this action must be equal to the attack's final Speed or less, rather than half of its Speed. If you succeed in your Parry, then the attacker must defend against your attack, using your Parry Roll as its Accuracy. You must use at least the same number of weapons as the attacker is using for this special Parry, and the weapons you use must be of the same type (all Shuriken, or all Senbon, etc).  Abilities that modify the attack's cost or reduce the attack's damage do not apply their accuracy bonus to your Parry roll.

*Upgrades From: Quick Draw*  
*Upgrades Into: Relentless*

##### Insidious
Your plans have plans, and they are all interwoven into the most innocuous actions. Even the smallest nick is part of a greater plot. Doses of Poison always cost 75 Ryo for you, and you don't have to select their Vector or Special Effects ahead of time. Instead, as a Speed 10 action, you may decide on a single dose of poison's Vector and Special Effect. As a separate Speed 10 action, you may expose anyone who has been damaged by being directly struck by the edge or point of one of your slashing or piercing weapons within the past 10 IC to a dose of Injury Poison you have on your person, consuming that poison. It turns out, that previous attack had a delayed reaction poison that only takes affect now. Finally, your current and maximum ranks in Toxicology are increased by 3, and you can craft Oil Flasks using Scrap.

*Upgrades From: Full Pockets*
