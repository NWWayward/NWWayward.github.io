...
toc:
 ...
 - name: Touu (Winter)
 - name: Yogani (Primal Fire)
 - name: Yotsuki (Balance)
---

During the war, a collective of monks studied the nature of chakra and it’s influence over the elements. They combined their efforts and worked together to instill this power into their bloodlines and it gave them power over the very environment itself. They could make land in an instant, and bring peace or ruin where they felt it was just.

## Hozuki (Primal Sea)
The monks of the Temperance reached out to the Hozuki clan for their ability to turn into water. While this was not an inherent connection to nature but more of a Ninshu ability to transform, it was refined under the training of the monks, someone that the clan would not want to pass up. A rare chance to test their abilities against other elemental masters.
...
## Senju (Spring, Noble)
The original founders of The Temperance sought to understand man’s connection to nature and ninshu. The Senju was the first clan that formed it. They made it the goal to use their connection with nature to bring peace to the land and try and discover others who would share their vision of using their Ninshu to help Nature heal the world.
...
## Terumi (Autumn, Noble)
One of the original founders of The Temperance. They understood the destructive powers of Heat and Water and when threatened by the Pride, were the driving force that aided in pushing back alongside the Senju. Together, the Senju and the Terumi were powerful allies that used their mastery of Earth, Fire, and Water, to make any terrain favorable and fight favorable. This solidified their claim as a Kyosha going forward and inspired others to join their cause.
...
## Touu (Winter)
The Touu actually emerged within The Temperance itself through a sort of Ninshu mutation and discovery with natural chakra. It led to the early breakthroughs of Suiton being able to just conjure water. The Touu go a step further and show an even more advanced control of wind and water. Being able to create and freeze water as they please, and with such control as to freeze the water within the air itself. Eventually the Touu solidified itself as a powerful clan over the next couple decades. Within the war, they sought the Temperance to take them in as refuge and preserve their clan. Without the help of the Temperance, they would have never have reached the level of mastery they have today.
...
## Yogani (Primal Fire)
A rare recessive trait that seems to come from the affinity of the Temuri and the Hitori. The Temperance has discovered that the nature of Ninshu has learned to evolve within people completely of it’s own will. Meaning that there could, theoretically, be a Chosen One concept to consider if Ninshu decided that there would be some kind of prophecy to fulfill. This mutation was the first of many to prove that Ninshu in human souls had a mind of it’s own and would manifest itself chaotically. Since then, Lava Release had been passed down heretically and is no longer endangered, promised to be preserved by The Temperance.

**Yogani begin with 1 less Unique Point.**

Yogani begin with Elemental Aptitude for Doton and Katon ninjutsu, along with the first rank of Elemental Affinity: Yoton, which includes Doton and Katon.

#### -=[ Yoton - Lava Release ]=-
Combining Fire and Doton chakra produces the destructive Lava Release, though not all Yoton are true ‘lava’ and sometimes will manifest as almost acidic, highly corrosive substances, not far removed from mud.

Any Katon or Doton technique can be converted to Yoton as a Chakra +5, Speed +0 link, with the following changes: 

 - Whenever Yoton inflicts a wound, it instead inflicts an Energy Wound, plus a Blunt Wound of one severity lower (to a minimum of Minor).
 - Non-Environmental Yoton inflicts Corrosion equal to its Rank (E = 1, D = 2, C = 3, B = 4, A = 5).
...
Yoton is weak to Suiton, and strong against Doton and Fuuton.

##### –( Corrosion )–
This is a status effect. As someone is struck by Yoton, they are struck by a combination of kinetic force and heat such that, unlike regular burns or simple kinetic force that one can shrug off in a matter of moments, Yoton has an ability to weaken anything it touches until it breaks, be it through impact or immersion as perhaps one of the most inherently destructive of all advanced elements.

When someone with Corrosion is hit by a damage dealing attack, they roll bonus damage dice. For every damage die showing a 1 or a 2, the attacker adds +1d6 damage. These d6s can trigger additional rolls if they roll a 1 or a 2. No more than (Corrosion)d6 bonus dice may be rolled in this fashion.
...
#### -–( Yoton: Yokai no Jutsu - Melting Apparition )–-
The user spits out a corrosive mud that erodes anything it touches on contact.  Though strong enough to stagger, what makes it truly deadly is the ability it has to overwhelm other jutsu and turn them into molten debris that flows with it to empower it.

 - Type: Yoton Ninjutsu, Rank C
 - Chakra: 27
 - Damage:  10d20.extra(11)
 - Area: 15
 - Speed: 12
 - Seal Speed: 11
 - Special: Destroys Armor, Interrupt
 - Tags: Energy, Projectile

Effects: This jutsu effectively replaces Earth Shore Return and Rising Phoenix Blast for Yogani. Those techniques can not be converted to Yoton.

When not used as an interrupt, this jutsu inflicts Corrosion 3, or increases an existing Corrosion by +3. This jutsu's damage is applied to every location of the target's body for purposes of impacting armor. Its damage is only reduced by armor in the location it actually wounds. Armor which doesn't degrade through being attacked is simply destroyed.

It may also be used as an interrupt against a damaging attack that would affect you, so long as this Jutsu's speed is equal to or less than the incoming attack's Speed (rather than half).

Roll this jutsu's damage, including bonus dice from the attacker's Corrosion. If this jutsu's damage is higher, their attack has no effect within this jutsu's area. The attacker and all other enemies within this jutsu's area increase their existing Corrosion, if any, by +3.

If their damage roll is higher, subtract your damage roll from theirs. That is how much damage their attack deals to you and anyone else it targets within this jutsu's area.

#### -–( Azure Flame Eruption )–-
The Yoton variant of Instant Cremation, the Yogani concentrates their Chakra on a specific point and a few moments later, the ground spontaneously erupts as a miniature volcano.  The more times it is used in an area, the more volcanic and molten the battlefield becomes.

 - Type: Yoton Ninjutsu, Rank B
 - Chakra: 24
 - Damage: (20 + X * 2)d20
 - Upkeep: X
 - Range: 30
...
Effects: This Jutsu replaces Instant Cremation for Yoton, which can not itself be converted to Yoton.

After using Azure Flame Eruption, you can choose to gain a special Upkeep X, which increases by 1 each time you use Azure Flame Eruption.

So long as X is one or greater, Azure Flame Eruption does not require handseals. Azure Flame Eruption’s special Upkeep is unaffected by Uniques or Wounds which would affect normal Upkeeps.

Azure Flame Eruption inflicts 4+X Corrosion, rather than 4.
...
Effects:  Select one element you have Aptitude for when you activate this technique. Your body becomes attuned to that element while you maintain it, causing an aura of that element to wreathe their body, protecting and empowering them.  You become immune to all non-environmental Status Effects from that element, reduce damage taken from that element by 25%, and cause your unarmed attacks to be considered the element chosen for the purposes of elemental interactions, as well as a bonus based on your chosen element:  
 ...
 - **Doton**:   You gain (8 + NDB) * (1 + X) Damage Reduction, and all of your damage-dealing, non-grapple unarmed attacks that are unaffected by partial success cause the target to be knocked prone (if the attack has no partial success, it does not gain this effect). If you attack someone who is prone, those same attacks also gain the Damage Reduction from this feature as added damage to your attack.
 ...
 - **Suiton**:  After successfully defending against an attack, you may perform a Basic Unarmed Attack as a Speed 0 interrupt at its normal cost; it is defended against at its normal speed, but does not advance your IC, though it may only be performed once every (14 - X * 2) IC. Every 10 gallons of Water on the battlefield causes you to be able to make this Interrupt attack at +1 Range, to a maximum of (NDB + X) yards, though they are still considered melee attacks, not ranged.

X begins at 0 for this technique.

#### -=[ Elemental Ascendance ]=-
With sufficient training, a Yotsuki can further concentrate their element, and even combine elements as they please.  While some choose to fully commit themselves to a singular element, others utilize the full abundance of nature in order to create multi-colored auras that allow for truly impossible types of taijutsu.

 - Base Cose: 5
 - Scale: 5
 - Limit: CHA/25, Max 4

Effects: For every Rank in this Ability, you can choose when you activate Kiryu, or as a separate Speed 6, CE 12 action, to do one of the following: Increase X by 1, or activate another Element.  In the latter case of adding additional elements, you do not gain additional status effect immunities (which are based solely on your ‘main’ element), however you do take less damage from all elements chosen, and your attacks are considered to be simultaneously all elements utilized for the purposes of defending against them.  You can utilize the separate action to likewise change which element is considered your main element for status effect immunities.

You must meet all of Kiryu’s normal rules for which elements you take (meaning you must have that element’s Aptitude), and activating more than one element causes Kiryu’s Upkeep to increase by 1 per additional element beyond the first, alongside potentially increasing it further if you do not have Affinity for all elements activated to qualify for its Special feature (meaning normally two elements active would be Upkeep 5 + 1 = 6, even if one of them is your affinity, as you are utilizing one which is not).