...
These clones may use basic attacks, dodge, parry, move, and can use Parchment Weapon Formation and Paper Shuriken, costing 1 AP per 3 speed of the action they perform.  They have access to the personal paper used to make them (and use it as personal paper of their own, though they can not use any other source of paper) and automatically reclaim all used paper. Unlike normal clones they can actually take damage, and have Vitality equal to five times the amount of personal paper they have available to them (lowering their maximum and current equally if they opt to use Parchment Weapon Formation), though if they take damage equal to or greater than their Vitality they are destroyed.  Regardless of if they are destroyed or unmade (by you making more, a different type of clone, or reabsorbing it), 20 sheets used to create the clones are destroyed; any amount above that to create them can be reclaimed.
